...
public final class Decoder {
    ...
    private static final String[] PUNCT_TABLE = {"", "\r", HTTP.CRLF, ". ", ", ", ": ", "!", "\"", "#", "$", "%", "&", "'", "(", ")", "*", "+", ",", "-", ".", "/", ":", ";", "<", "=", ">", "?", "[", "]", "{", "}", "CTRL_UL"};
        ...
        while (i7 < nbLayers) {
            ...
            while (i12 < i9) {
                ...
                while (i14 < i2) {
                    ...
                    int i17 = i11 - i14;
                    zArr[(2 * i9) + i8 + i13 + i14] = bitMatrix.get(iArr[i16], iArr[i17]);
                    int i18 = i11 - i12;
                    zArr[(4 * i9) + i8 + i13 + i14] = bitMatrix.get(iArr[i17], iArr[i18]);
    ...
    private static int totalBitsInLayer(int i, boolean z) {
        return ((z ? 88 : R.styleable.AppCompatTheme_windowMinWidthMajor) + (i << 4)) * i;
    }
