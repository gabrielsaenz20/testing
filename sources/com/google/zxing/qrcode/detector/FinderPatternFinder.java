...
public class FinderPatternFinder {
    ...
    private boolean crossCheckDiagonal(int i, int i2, int i3, int i4) {
        ...
        return crossCheckStateCount[4] < i3 && Math.abs(((((crossCheckStateCount[0] + crossCheckStateCount[1]) + crossCheckStateCount[2]) + crossCheckStateCount[3]) + crossCheckStateCount[4]) - i4) < 2 * i4 && foundPatternCross(crossCheckStateCount);
    }
    ...
    private float crossCheckHorizontal(int i, int i2, int i3, int i4) {
        ...
        if (crossCheckStateCount[4] < i3 && 5 * Math.abs(((((crossCheckStateCount[0] + crossCheckStateCount[1]) + crossCheckStateCount[2]) + crossCheckStateCount[3]) + crossCheckStateCount[4]) - i4) < i4 && foundPatternCross(crossCheckStateCount)) {
    ...
    private float crossCheckVertical(int i, int i2, int i3, int i4) {
        ...
        if (crossCheckStateCount[4] < i3 && 5 * Math.abs(((((crossCheckStateCount[0] + crossCheckStateCount[1]) + crossCheckStateCount[2]) + crossCheckStateCount[3]) + crossCheckStateCount[4]) - i4) < 2 * i4 && foundPatternCross(crossCheckStateCount)) {
            return centerFromEnd(crossCheckStateCount, i6);
        }
        return Float.NaN;
    }
    ...
    private boolean haveMultiplyConfirmedCenters() {
        ...
        return fAbs <= 0.05f * estimatedModuleSize;
    }
