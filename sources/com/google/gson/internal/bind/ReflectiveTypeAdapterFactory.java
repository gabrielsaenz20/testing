            ...
            while (i < length) {
                ...
                if (zExcludeField || zExcludeField2) {
                    ...
                    while (r2 < size) {
                        ...
                        boolean z2 = r2 != 0 ? false : zExcludeField;
                        ...
                        Field field2 = field;
                        boundField = boundField2 == null ? (BoundField) linkedHashMap.put(str, reflectiveTypeAdapterFactory2.createBoundField(gson, field, str, TypeToken.get(typeResolve), z2, zExcludeField2)) : boundField2;
                        zExcludeField = z2;
                        typeResolve = type2;
                        size = i3;
                        fieldNames = list;
