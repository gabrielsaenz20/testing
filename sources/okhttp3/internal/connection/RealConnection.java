                ...
                try {
                    if (this.route.requiresTunnel()) {
                        ...
                        try {
                            ...
                            eventListener.connectFailed(call, this.route.socketAddress(), this.route.proxy(), null, iOException2);
                    ...
                    this.protocol = null;
                    this.http2Connection = null;
                    eventListener.connectFailed(call, this.route.socketAddress(), this.route.proxy(), null, iOException22);
                    if (routeException != null) {
                    }
                    if (z) {
                    }
