...
public final class MotionEventCompat {
    ...
    static {
        IMPL = Build.VERSION.SDK_INT >= 14 ? new ICSMotionEventVersionImpl() : Build.VERSION.SDK_INT >= 12 ? new HoneycombMr1MotionEventVersionImpl() : new BaseMotionEventVersionImpl();
    }
