...
public final class AccessibilityEventCompat {
    ...
    static {
        IMPL = Build.VERSION.SDK_INT >= 19 ? new AccessibilityEventKitKatImpl() : Build.VERSION.SDK_INT >= 16 ? new AccessibilityEventJellyBeanImpl() : Build.VERSION.SDK_INT >= 14 ? new AccessibilityEventIcsImpl() : new AccessibilityEventStubImpl();
    }
