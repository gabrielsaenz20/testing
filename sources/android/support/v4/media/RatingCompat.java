    ...
    public Object getRating() {
        ...
        if (isRated()) {
            switch (this.mRatingStyle) {
                case 1:
                    objNewUnratedRating = RatingCompatKitkat.newHeartRating(hasHeart());
                    break;
                case 2:
                    objNewUnratedRating = RatingCompatKitkat.newThumbRating(isThumbUp());
                    break;
                case 3:
                case 4:
                case 5:
                    objNewUnratedRating = RatingCompatKitkat.newStarRating(this.mRatingStyle, getStarRating());
                    break;
                case 6:
            ...
            objNewUnratedRating = RatingCompatKitkat.newUnratedRating(this.mRatingStyle);
        }
        this.mRatingObj = objNewUnratedRating;
        return this.mRatingObj;
    }
