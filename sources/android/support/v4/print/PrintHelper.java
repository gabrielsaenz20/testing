...
public final class PrintHelper {
    ...
    public PrintHelper(Context context) {
        if (systemSupportsPrint()) {
            this.mImpl = Build.VERSION.SDK_INT >= 24 ? new PrintHelperApi24Impl(context) : Build.VERSION.SDK_INT >= 23 ? new PrintHelperApi23Impl(context) : Build.VERSION.SDK_INT >= 20 ? new PrintHelperApi20Impl(context) : new PrintHelperKitkatImpl(context);
        } else {
