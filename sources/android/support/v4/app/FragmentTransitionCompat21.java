...
class FragmentTransitionCompat21 {
    ...
    public static void scheduleNameReset(final ViewGroup viewGroup, final ArrayList<View> arrayList, final Map<String, String> map) {
        viewGroup.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() { // from class: android.support.v4.app.FragmentTransitionCompat21.7
    ...
    public static void setNameOverridesOptimized(final View view, final ArrayList<View> arrayList, final ArrayList<View> arrayList2, final ArrayList<String> arrayList3, Map<String, String> map) {
        ...
        view.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() { // from class: android.support.v4.app.FragmentTransitionCompat21.3
            @Override // android.view.ViewTreeObserver.OnPreDrawListener
            public boolean onPreDraw() {
    ...
    public static void setNameOverridesUnoptimized(final View view, final ArrayList<View> arrayList, final Map<String, String> map) {
