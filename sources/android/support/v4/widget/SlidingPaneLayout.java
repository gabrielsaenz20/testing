...
public class SlidingPaneLayout extends ViewGroup {
    ...
    */
    ...
    protected boolean canScroll(View view, boolean z, int i, int i2, int i3) {
        ...
        if (z) {
            return ViewCompat.canScrollHorizontally(view, isLayoutRtlSupport() ? i : -i);
        }
        return false;
    }
  ...
  0x00b1: PHI (r13v2 float) = (r13v1 float), (r13v3 float) binds: [B:35:0x00a6, B:37:0x00ad] A[DONT_GENERATE, DONT_INLINE]] */
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width != 0) {
                    ...
                    if (layoutParams.width == -2) {
                        iMakeMeasureSpec4 = View.MeasureSpec.makeMeasureSpec(paddingLeft - i12, Integer.MIN_VALUE);
                    } else {
                        ...
                        iMakeMeasureSpec4 = View.MeasureSpec.makeMeasureSpec(i8, i7);
                    }
                    if (layoutParams.height == -2) {
                        ...
                        iMakeMeasureSpec5 = View.MeasureSpec.makeMeasureSpec(layoutParams.height, 1073741824);
                        childAt.measure(iMakeMeasureSpec4, iMakeMeasureSpec5);
                        int measuredWidth = childAt.getMeasuredWidth();
                        measuredHeight3 = childAt.getMeasuredHeight();
                        if (mode2 == Integer.MIN_VALUE && measuredHeight3 > iMin) {
                    ...
                    iMakeMeasureSpec5 = View.MeasureSpec.makeMeasureSpec(paddingTop, i9);
                    childAt.measure(iMakeMeasureSpec4, iMakeMeasureSpec5);
            ...
            while (i14 < childCount) {
                ...
                if (childAt2.getVisibility() == i3) {
                    ...
                    if (childAt2.getVisibility() != i3) {
                            ...
                            if (layoutParams2.weight > 0.0f) {
                                if (layoutParams2.width != 0) {
                                    ...
                                    if (z2) {
                                        ...
                                        i5 = i13;
                                        childAt2.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth3 + ((int) ((layoutParams2.weight * Math.max(0, i11)) / f)), 1073741824), iMakeMeasureSpec2);
                                    }
                        ...
                        } else if (layoutParams2.width < 0 && (measuredWidth3 > i13 || layoutParams2.weight > 0.0f)) {
                            if (z5) {
                                if (layoutParams2.height == -2) {
                                    ...
                                    i6 = 1073741824;
                                    measuredHeight2 = layoutParams2.height;
                                }
                                childAt2.measure(View.MeasureSpec.makeMeasureSpec(i13, i6), iMakeMeasureSpec3);
                            } else {
                                i6 = 1073741824;
