...
final class CollapsingTextHelper {
    ...
    */
    private void calculateBaseOffsets() {
        ...
        if (i4 == 48) {
            fAscent = this.mCollapsedBounds.top - this.mTextPaint.ascent();
        } else {
            if (i4 != 80) {
                ...
                if (i != 1) {
                    fCenterX = this.mCollapsedBounds.centerX();
                    fMeasureText /= 2.0f;
                } else {
                    if (i != 5) {
                        ...
                        i2 = absoluteGravity2 & R.styleable.AppCompatTheme_windowMinWidthMajor;
                        if (i2 == 48) {
                            fAscent2 = this.mExpandedBounds.top - this.mTextPaint.ascent();
                        } else {
                            if (i2 != 80) {
                                ...
                                if (i3 != 1) {
                                    fCenterX2 = this.mExpandedBounds.centerX();
                                    fMeasureText2 /= 2.0f;
                                } else {
                                    if (i3 != 5) {
                                        f = this.mExpandedBounds.left;
                                        this.mExpandedDrawX = f;
                                        clearTexture();
                                        setInterpolatedTextSize(f2);
                                    }
                                    fCenterX2 = this.mExpandedBounds.right;
                                }
                            ...
                            fAscent2 = this.mExpandedBounds.bottom;
                        }
                        this.mExpandedDrawY = fAscent2;
                        i3 = absoluteGravity2 & GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK;
                        if (i3 != 1) {
                        }
                        f = fCenterX2 - fMeasureText2;
                    ...
                    fCenterX = this.mCollapsedBounds.right;
                }
                this.mCollapsedDrawX = fCenterX - fMeasureText;
                calculateUsingTextSize(this.mExpandedTextSize);
                if (this.mTextToDraw != null) {
                }
                int absoluteGravity22 = GravityCompat.getAbsoluteGravity(this.mExpandedTextGravity, this.mIsRtl ? 1 : 0);
                i2 = absoluteGravity22 & R.styleable.AppCompatTheme_windowMinWidthMajor;
                if (i2 == 48) {
                }
                this.mExpandedDrawY = fAscent2;
            ...
            fAscent = this.mCollapsedBounds.bottom;
        }
        this.mCollapsedDrawY = fAscent;
        i = absoluteGravity & GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK;
        if (i != 1) {
        }
        this.mCollapsedDrawX = fCenterX - fMeasureText;
        ...
        int absoluteGravity222 = GravityCompat.getAbsoluteGravity(this.mExpandedTextGravity, this.mIsRtl ? 1 : 0);
        i2 = absoluteGravity222 & R.styleable.AppCompatTheme_windowMinWidthMajor;
        if (i2 == 48) {
        }
        this.mExpandedDrawY = fAscent2;
