...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent {
    ...
    private void getDesiredAnchoredChildRectWithoutConstraints(View view, int i, Rect rect, Rect rect2, LayoutParams layoutParams, int i2, int i3) {
        ...
        int i5 = absoluteGravity & R.styleable.AppCompatTheme_windowMinWidthMajor;
        int i6 = absoluteGravity2 & 7;
        int i7 = absoluteGravity2 & R.styleable.AppCompatTheme_windowMinWidthMajor;
    ...
    private void layoutChildWithKeyline(View view, int i, int i2) {
        ...
        int i4 = absoluteGravity & R.styleable.AppCompatTheme_windowMinWidthMajor;
        int width = getWidth();
        int height = getHeight();
    ...
    */
    protected void onMeasure(int i, int i2) {
            ...
            if (view2.getVisibility() == 8) {
                ...
                if (layoutParams.keyline < 0 || mode == 0) {
                    ...
                    if (behavior == null) {
                        ...
                        View view3 = view;
                        int iMax3 = Math.max(i5, i10 + view3.getMeasuredWidth() + layoutParams.leftMargin + layoutParams.rightMargin);
                        iMax2 = Math.max(i7, i11 + view3.getMeasuredHeight() + layoutParams.topMargin + layoutParams.bottomMargin);
                        iCombineMeasuredStates = ViewCompat.combineMeasuredStates(i8, ViewCompat.getMeasuredState(view3));
                        i12 = iMax3;
                    } else {
                        view = view2;
                        i5 = i12;
                    ...
                    View view32 = view;
                    int iMax32 = Math.max(i5, i10 + view32.getMeasuredWidth() + layoutParams.leftMargin + layoutParams.rightMargin);
                    iMax2 = Math.max(i7, i11 + view32.getMeasuredHeight() + layoutParams.topMargin + layoutParams.bottomMargin);
                    iCombineMeasuredStates = ViewCompat.combineMeasuredStates(i8, ViewCompat.getMeasuredState(view32));
                    i12 = iMax32;
                }
                iMax = 0;
                if (z2) {
                    ...
                    onMeasureChild(view, iMakeMeasureSpec, iMax, iMakeMeasureSpec2, 0);
                    View view322 = view;
                    int iMax322 = Math.max(i5, i10 + view322.getMeasuredWidth() + layoutParams.leftMargin + layoutParams.rightMargin);
                    iMax2 = Math.max(i7, i11 + view322.getMeasuredHeight() + layoutParams.topMargin + layoutParams.bottomMargin);
                    iCombineMeasuredStates = ViewCompat.combineMeasuredStates(i8, ViewCompat.getMeasuredState(view322));
                    i12 = iMax322;
                }
            }
            i13 = i9 + 1;
        ...
        setMeasuredDimension(ViewCompat.resolveSizeAndState(i12, i, (-16777216) & i14), ViewCompat.resolveSizeAndState(iMax2, i2, i14 << 16));
    }
