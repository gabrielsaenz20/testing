        ...
        while (!arrayList2.isEmpty()) {
            ...
            if (snakeDiffPartial != null) {
                ...
                if (snakeDiffPartial.reverse) {
                    ...
                    if (snakeDiffPartial.reverse) {
                        i3 = snakeDiffPartial.x + snakeDiffPartial.size;
                    } else if (snakeDiffPartial.removal) {
                        i3 = snakeDiffPartial.x + snakeDiffPartial.size + 1;
                    } else {
                        range.oldListStart = snakeDiffPartial.x + snakeDiffPartial.size;
                        i4 = snakeDiffPartial.y + snakeDiffPartial.size + 1;
                        range.newListStart = i4;
                        arrayList2.add(range);
                    }
                    range.oldListStart = i3;
                    i4 = snakeDiffPartial.y + snakeDiffPartial.size;
                    range.newListStart = i4;
                    arrayList2.add(range);
                }
