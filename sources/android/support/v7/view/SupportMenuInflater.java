    ...
    private class MenuState {
        ...
        public void readItem(AttributeSet attributeSet) {
            ...
            if (z && this.itemActionViewLayout == 0 && this.itemActionViewClassName == null) {
                actionProvider = (ActionProvider) newInstance(this.itemActionProviderClassName, SupportMenuInflater.ACTION_PROVIDER_CONSTRUCTOR_SIGNATURE, SupportMenuInflater.this.mActionProviderConstructorArguments);
            } else {
                if (z) {
