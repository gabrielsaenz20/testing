...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    /* JADX WARN: Removed duplicated region for block: B:26:0x005d A[PHI: r11 r12
  0x005d: PHI (r11v5 int) = (r11v0 int), (r11v6 int) binds: [B:34:0x006f, B:25:0x005b] A[DONT_GENERATE, DONT_INLINE]
  0x005d: PHI (r12v19 android.content.res.TypedArray) = (r12v18 android.content.res.TypedArray), (r12v21 android.content.res.TypedArray) binds: [B:34:0x006f, B:25:0x005b] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        if (theme != null) {
            ...
            if (resourceId == 0) {
                ...
                if (this.mPopupContext != null) {
                    if (i2 == -1) {
                        TypedArray typedArray = Build.VERSION.SDK_INT;
                        try {
                            if (typedArray >= 11) {
                                try {
                                ...
                                try {
                                    ...
                                    textArray = tintTypedArrayObtainStyledAttributes.getTextArray(android.support.v7.appcompat.R.styleable.Spinner_android_entries);
                                    if (textArray != null) {
                                    }
