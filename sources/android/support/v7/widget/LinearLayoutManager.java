...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider, ItemTouchHelper.ViewDropHandler {
    ...
    public View onFocusSearchFailed(View view, int i, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        ensureLayoutState();
        View viewFindReferenceChildClosestToStart = iConvertFocusDirectionToLayoutDirection == -1 ? findReferenceChildClosestToStart(recycler, state) : findReferenceChildClosestToEnd(recycler, state);
        ...
        if (childClosestToStart == viewFindReferenceChildClosestToStart || !childClosestToStart.isFocusable()) {
            return null;
        }
