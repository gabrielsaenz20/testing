...
class AlertController {
        ...
        */
        public void onClick(View view) {
            ...
            if (view == AlertController.this.mButtonPositive && AlertController.this.mButtonPositiveMessage != null) {
                message = AlertController.this.mButtonPositiveMessage;
            } else if (view == AlertController.this.mButtonNegative && AlertController.this.mButtonNegativeMessage != null) {
                message = AlertController.this.mButtonNegativeMessage;
            } else {
                ...
                message = AlertController.this.mButtonNeutralMessage;
            }
        ...
        private void createListView(final AlertController alertController) {
            ...
            if (this.mOnClickListener == null) {
                if (this.mOnCheckboxClickListener != null) {
                    onItemClickListener = new AdapterView.OnItemClickListener() { // from class: android.support.v7.app.AlertController.AlertParams.4
            ...
            onItemClickListener = new AdapterView.OnItemClickListener() { // from class: android.support.v7.app.AlertController.AlertParams.3
                @Override // android.widget.AdapterView.OnItemClickListener
                public void onItemClick(AdapterView<?> adapterView, View view, int i2, long j) {
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        final View viewFindViewById = this.mWindow.findViewById(android.support.v7.appcompat.R.id.scrollIndicatorUp);
    ...
    private void setupView() {
        ...
        if (z2 != 0) {
            ...
            if ((this.mMessage != null || this.mListView != null || z) && !z) {
                viewFindViewById10 = viewGroupResolvePanel.findViewById(android.support.v7.appcompat.R.id.titleDividerNoCustom);
            }
