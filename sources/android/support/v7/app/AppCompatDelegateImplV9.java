...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements LayoutInflaterFactory, MenuBuilder.Callback {
    ...
    private ViewGroup createSubDecor() throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        if (this.mWindowNoTitle) {
            ViewGroup viewGroup2 = (ViewGroup) layoutInflaterFrom.inflate(this.mOverlayActionMode ? R.layout.abc_screen_simple_overlay_action_mode : R.layout.abc_screen_simple, (ViewGroup) null);
    ...
    */
    ...
    public void installViewFactory() {
        ...
        if (layoutInflaterFrom.getFactory() == null) {
            ...
            if (LayoutInflaterCompat.getFactory(layoutInflaterFrom) instanceof AppCompatDelegateImplV9) {
                return;
            }
