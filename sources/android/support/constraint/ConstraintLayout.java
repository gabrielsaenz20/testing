                            ...
                            if (iIndexOf2 < 0 || iIndexOf2 >= length - 1) {
                                ...
                                if (strSubstring3.length() > 0 && strSubstring4.length() > 0) {
                                    try {
                                        ...
                                        if (f > 0.0f && f2 > 0.0f) {
                                            fAbs = this.dimensionRatioSide == 1 ? Math.abs(f2 / f) : Math.abs(f / f2);
                                            this.dimensionRatioValue = fAbs;
                                        }
                            ...
                            if (resolvedValue == 0) {
                                if (z7 && constraintWidget2.isSpreadWidth() && z5 && resolutionNode.isResolved() && resolutionNode2.isResolved()) {
                                    ...
                                    if (resolvedValue2 == 0) {
                                        i6 = i12;
                                        if (resolvedValue2 == -1) {
                                            childMeasureSpec2 = getChildMeasureSpec(i2, i6, -1);
                                            z2 = false;
                                            ...
                                            z2 = resolvedValue2 == -2;
                                            childMeasureSpec2 = getChildMeasureSpec(i2, i6, resolvedValue2);
                                            childAt2.measure(childMeasureSpec, childMeasureSpec2);
                                            if (this.mMetrics == null) {
                                            }
                                            constraintWidget2.setWidthWrapContent(resolvedValue != -2);
                                        ...
                                        if (z) {
                                            constraintWidget2.setWrapWidth(measuredWidth2222);
                                        }
                                        if (z2) {
                                            constraintWidget2.setWrapHeight(measuredHeight2222);
                                        }
                                        if (z7) {
                                            constraintWidget2.getResolutionWidth().remove();
                                        } else {
                                            constraintWidget2.getResolutionWidth().resolve(measuredWidth2222);
                                        }
                                        if (z8) {
                                            constraintWidget2.getResolutionHeight().remove();
                                        } else {
                                            constraintWidget2.getResolutionHeight().resolve(measuredHeight2222);
                                        }
            ...
            if (viewWidget2 != null) {
                ...
                if (layoutParams.isGuideline) {
                    ...
                    if (layoutParams.circleConstraint != -1) {
                        ...
                        if (i27 != -1) {
                            targetWidget2 = getTargetWidget(i27);
                            if (targetWidget2 != null) {
                                type = ConstraintAnchor.Type.RIGHT;
                                type2 = ConstraintAnchor.Type.LEFT;
                                viewWidget2.immediateConnect(type, targetWidget2, type2, layoutParams.rightMargin, i2);
                            }
                            if (layoutParams.topToTop == -1) {
                                targetWidget3 = getTargetWidget(layoutParams.topToTop);
                                if (targetWidget3 != null) {
                                    type3 = ConstraintAnchor.Type.TOP;
                                    type4 = ConstraintAnchor.Type.TOP;
                                    viewWidget2.immediateConnect(type3, targetWidget3, type4, layoutParams.topMargin, layoutParams.goneTopMargin);
                                }
                                if (layoutParams.bottomToTop == -1) {
                                    targetWidget4 = getTargetWidget(layoutParams.bottomToTop);
                                    if (targetWidget4 != null) {
                                        type5 = ConstraintAnchor.Type.BOTTOM;
                                        type6 = ConstraintAnchor.Type.TOP;
                                        viewWidget2.immediateConnect(type5, targetWidget4, type6, layoutParams.bottomMargin, layoutParams.goneBottomMargin);
                                    }
                                    if (layoutParams.baselineToBaseline != -1) {
                                        View view = this.mChildrenByIds.get(layoutParams.baselineToBaseline);
                                        ConstraintWidget targetWidget7 = getTargetWidget(layoutParams.baselineToBaseline);
                                        if (targetWidget7 != null && view != null && (view.getLayoutParams() instanceof LayoutParams)) {
                                            LayoutParams layoutParams2 = (LayoutParams) view.getLayoutParams();
                                            layoutParams.needsBaseline = true;
                                            layoutParams2.needsBaseline = true;
                                            viewWidget2.getAnchor(ConstraintAnchor.Type.BASELINE).connect(targetWidget7.getAnchor(ConstraintAnchor.Type.BASELINE), 0, -1, ConstraintAnchor.Strength.STRONG, 0, true);
                                    ...
                                    if (layoutParams.bottomToBottom != -1 && (targetWidget4 = getTargetWidget(layoutParams.bottomToBottom)) != null) {
                                        type5 = ConstraintAnchor.Type.BOTTOM;
                                ...
                                if (layoutParams.topToBottom != -1 && (targetWidget3 = getTargetWidget(layoutParams.topToBottom)) != null) {
                                    type3 = ConstraintAnchor.Type.TOP;
                            ...
                            if (i4 != -1 && (targetWidget2 = getTargetWidget(i4)) != null) {
                                type = ConstraintAnchor.Type.RIGHT;
                ...
                if (view == null) {
                    ...
                    if (layoutParams.isHelper || layoutParams.isGuideline) {
                        ...
                        if (view.getVisibility() != 8 && (!z3 || !constraintWidget.getResolutionWidth().isResolved() || !constraintWidget.getResolutionHeight().isResolved())) {
                            view.measure((layoutParams.width == -2 && layoutParams.horizontalDimensionFixed) ? getChildMeasureSpec(i8, paddingRight, layoutParams.width) : View.MeasureSpec.makeMeasureSpec(constraintWidget.getWidth(), 1073741824), (layoutParams.height == -2 && layoutParams.verticalDimensionFixed) ? getChildMeasureSpec(i2, paddingBottom, layoutParams.height) : View.MeasureSpec.makeMeasureSpec(constraintWidget.getHeight(), 1073741824));
                            if (this.mMetrics != null) {
                            ...
                            if (measuredWidth != constraintWidget.getWidth()) {
                                ...
                                if (z4 && constraintWidget.getRight() > iMax3) {
