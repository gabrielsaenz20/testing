        ...
        while (eventType != 1) {
            ...
            if (eventType == 2) {
                ...
                if (ANIMATED_VECTOR.equals(name)) {
                    typedArrayObtainAttributes = VectorDrawableCommon.obtainAttributes(resources, theme, attributeSet, AndroidResources.styleable_AnimatedVectorDrawable);
                    ...
                    typedArrayObtainAttributes = resources.obtainAttributes(attributeSet, AndroidResources.styleable_AnimatedVectorDrawableTarget);
