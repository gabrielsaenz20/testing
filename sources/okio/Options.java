...
public final class Options extends AbstractList<ByteString> implements RandomAccess {
    ...
    private static void buildTrieRecursive(long j, Buffer buffer, int i, List<ByteString> list, int i2, int i3, List<Integer> list2) {
        ...
        if (byteString.getByte(i) == byteString2.getByte(i)) {
            ...
            long jIntCount = j + intCount(buffer) + 2 + i9 + 1;
            buffer.writeInt(-i9);
            ...
            if (i8 + 1 == i3) {
                ...
                buildTrieRecursive(jIntCount, buffer2, i4, list, i8, i3, list2);
        ...
        long jIntCount2 = j + intCount(buffer) + 2 + (i12 * 2);
        buffer.writeInt(i12);
        buffer.writeInt(iIntValue);
        for (int i14 = i8; i14 < i3; i14++) {
            byte b = list.get(i14).getByte(i);
            if (i14 == i8 || b != list.get(i14 - 1).getByte(i)) {
        ...
        while (i15 < i3) {
            ...
            if (i16 == i5 && i + 1 == list.get(i15).size()) {
                buffer.writeInt(list2.get(i15).intValue());
            } else {
                buffer.writeInt((int) ((intCount(buffer3) + jIntCount2) * (-1)));
                buildTrieRecursive(jIntCount2, buffer3, i + 1, list, i15, i5, list2);
            }
            i15 = i5;
        }
