...
public class WebRtcAudioTrack {
    ...
    private class AudioTrackThread extends Thread {
        ...
        public void run() throws IllegalStateException, SecurityException, IllegalArgumentException {
            ...
            while (this.keepAlive) {
                WebRtcAudioTrack.this.nativeGetPlayoutData(iCapacity, WebRtcAudioTrack.this.nativeAudioTrack);
    ...
    private int initPlayout(int i, int i2, double d) {
        ...
        try {
            this.audioTrack = Build.VERSION.SDK_INT >= 21 ? createAudioTrackOnLollipopOrHigher(i, iChannelCountToConfiguration, minBufferSize) : createAudioTrackOnLowerThanLollipop(i, iChannelCountToConfiguration, minBufferSize);
