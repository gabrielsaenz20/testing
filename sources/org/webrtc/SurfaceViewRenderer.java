...
public class SurfaceViewRenderer extends SurfaceView implements SurfaceHolder.Callback, RendererCommon.RendererEvents, VideoSink {
    ...
    private void updateSurfaceSize() {
        ...
        int iMin2 = Math.min(getHeight(), i);
    ...
    final /* synthetic */ void lambda$onFrameResolutionChanged$0$SurfaceViewRenderer(int i, int i2) {
    ...
    public void onFrameResolutionChanged(final int i, int i2, int i3) {
        ...
        postOrRun(new Runnable(this, i4, i) { // from class: org.webrtc.SurfaceViewRenderer$$Lambda$0
