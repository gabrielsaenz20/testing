...
class Camera1Session implements CameraSession {
    ...
    class AnonymousClass2 implements Camera.PreviewCallback {
        ...
        final /* synthetic */ void lambda$onPreviewFrame$0$Camera1Session$2(byte[] bArr) {
            if (Camera1Session.this.state == SessionState.RUNNING) {
                Camera1Session.this.camera.addCallbackBuffer(bArr);
            }
        }

        final /* synthetic */ void lambda$onPreviewFrame$1$Camera1Session$2(final byte[] bArr) {
            Camera1Session.this.cameraThreadHandler.post(new Runnable(this, bArr) { // from class: org.webrtc.Camera1Session$2$$Lambda$1
                private final Camera1Session.AnonymousClass2 arg$1;
        ...
        public void onPreviewFrame(final byte[] bArr, Camera camera) {
            ...
            VideoFrame videoFrame = new VideoFrame(new NV21Buffer(bArr, Camera1Session.this.captureFormat.width, Camera1Session.this.captureFormat.height, new Runnable(this, bArr) { // from class: org.webrtc.Camera1Session$2$$Lambda$0
                private final Camera1Session.AnonymousClass2 arg$1;
                private final byte[] arg$2;
    ...
    private void listenForTextureFrames() {
        this.surfaceTextureHelper.startListening(new VideoSink(this) { // from class: org.webrtc.Camera1Session$$Lambda$0
    ...
    final /* synthetic */ void lambda$listenForTextureFrames$0$Camera1Session(VideoFrame videoFrame) {
        checkIsOnCameraThread();
