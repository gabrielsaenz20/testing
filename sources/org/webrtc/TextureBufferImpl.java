...
public class TextureBufferImpl implements VideoFrame.TextureBuffer {
    ...
    private TextureBufferImpl(int i, int i2, int i3, int i4, VideoFrame.TextureBuffer.Type type, int i5, Matrix matrix, Handler handler, YuvConverter yuvConverter, final RefCountMonitor refCountMonitor) {
        ...
        this.refCountDelegate = new RefCountDelegate(new Runnable(this, refCountMonitor) { // from class: org.webrtc.TextureBufferImpl$$Lambda$0
            ...
            public void run() {
                this.arg$1.lambda$new$0$TextureBufferImpl(this.arg$2);
            }
        });
    ...
    final /* synthetic */ void lambda$new$0$TextureBufferImpl(RefCountMonitor refCountMonitor) {
        refCountMonitor.onDestroy(this);
    }

    final /* synthetic */ VideoFrame.I420Buffer lambda$toI420$1$TextureBufferImpl() {
    ...
    public VideoFrame.I420Buffer toI420() {
        return (VideoFrame.I420Buffer) ThreadUtils.invokeAtFrontUninterruptibly(this.toI420Handler, new Callable(this) { // from class: org.webrtc.TextureBufferImpl$$Lambda$1
            ...
            public Object call() {
                return this.arg$1.lambda$toI420$1$TextureBufferImpl();
            }
        });
    }
}
