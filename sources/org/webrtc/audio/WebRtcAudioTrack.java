...
class WebRtcAudioTrack {
    ...
    WebRtcAudioTrack(Context context, AudioManager audioManager, @Nullable AudioAttributes audioAttributes, @Nullable JavaAudioDeviceModule.AudioTrackErrorCallback audioTrackErrorCallback, @Nullable JavaAudioDeviceModule.AudioTrackStateCallback audioTrackStateCallback, boolean z) {
    ...
    private int initPlayout(int i, int i2, double d) {
        ...
        try {
            this.audioTrack = (!this.useLowLatency || Build.VERSION.SDK_INT < 26) ? Build.VERSION.SDK_INT >= 21 ? createAudioTrackOnLollipopOrHigher(i, iChannelCountToConfiguration, minBufferSize, this.audioAttributes) : createAudioTrackOnLowerThanLollipop(i, iChannelCountToConfiguration, minBufferSize) : createAudioTrackOnOreoOrHigher(i, iChannelCountToConfiguration, minBufferSize, this.audioAttributes);
